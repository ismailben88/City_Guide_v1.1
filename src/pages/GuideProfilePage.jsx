...
import {
  RiArrowLeftLine, RiShieldCheckLine, RiMapPin2Line, RiCompassLine,
  RiMailLine, RiPhoneLine, RiWhatsappLine, RiInstagramLine, RiGlobalLine,
} from "react-icons/ri";
import {
  TbLanguage, TbClock, TbRoute, TbCalendarEvent,
  TbCheck, TbX, TbMoodSmile,
} from "react-icons/tb";
...
function Section({ title, icon, children }) {
  return (
    <div className="bg-white rounded-[20px] border border-[#ede8e0]
      ...
      <h3 className="flex items-center gap-2 text-[11px] font-black uppercase
...
function LoadingSkeleton() {
  return (
    <div className="min-h-screen bg-[#faf7f2] animate-pulse">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 grid grid-cols-1
...
export default function GuideProfilePage() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    api.getGuideById(id)
      .then((data) => { if (!cancelled) { setGuide(data); setLoading(false); } })
          ...
          <div className="max-w-6xl mx-auto flex flex-col sm:flex-row
            ...
            <div className="flex items-end gap-4 flex-1 min-w-0">
              ...
              <div className="relative shrink-0">
                <div className="w-[90px] h-[90px] rounded-[18px] border-[3px] border-white/80
              ...
              <div className="min-w-0 pb-1">
                ...
                <div className="flex items-center gap-2 flex-wrap mb-1">
                  <h1 className="font-[Playfair_Display,Georgia,serif] text-[26px]
                                 font-bold text-white leading-tight drop-shadow-sm">
                    {g.name}
                  </h1>
                  {isVerified && (
                    <span className="inline-flex items-center gap-1 px-2 py-[3px]
                ...
                {g.cityNames?.length > 0 && (
                  <p className="flex items-center gap-1 text-white/75 text-[13px]
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  <div className="flex items-center gap-1.5">
                    <span className="flex items-center gap-px text-[#f4b942]">
                      ...
                      {[...Array(emptyStars)].map((_,i) =>
                        <IoStarOutline key={`e${i}`} size={13} className="opacity-50" />)}
                    </span>
                  ...
                  <span className={`inline-flex items-center gap-1 px-2.5 py-[3px]
            ...
            <div className="flex items-center gap-3 sm:pb-1 shrink-0">
              <div className="text-right hidden sm:block">
                ...
                <p className="text-white font-[Playfair_Display,Georgia,serif]
      ...
      <div className="max-w-2xl mx-auto px-4 mb-8">
        <div className="bg-white rounded-[20px] border border-[#ede8e0]
          ...
          <div className="grid grid-cols-4 divide-x divide-[#ede8e0]">
            {[
              { value: g.averageRating?.toFixed(1), label: "Rating",    note: "/ 5.0" },
              { value: g.totalTours,                label: "Tours",     note: "done"  },
              { value: g.pricePerHour,              label: "MAD / hr",  note: ""      },
              { value: g.spokenLanguages?.length||0, label: "Languages", note: ""     },
            ].map(({ value, label, note }) => (
              <div key={label} className="flex flex-col items-center py-4 gap-0.5">
                <span className="font-[Playfair_Display,Georgia,serif] text-[20px]
          ...
          <div className="space-y-5">
            ...
            <Section title="About" icon={<RiCompassLine size={13} />}>
              <p className="font-[Nunito,sans-serif] text-[14px] text-[#7a6a58] leading-[1.8]">
                {g.bio || "Expert local guide ready to show you the best of Morocco."}
              </p>
            </Section>
            ...
            {/* Reviews */}
            <Section title="Reviews & Community" icon={<IoStarSharp size={13} />}>
          ...
          <aside className="space-y-5">
            ...
            <div className="bg-white rounded-[20px] border border-[#ede8e0]
              ...
              <div className="flex items-baseline gap-1 mb-1">
                <span className="font-[Playfair_Display,Georgia,serif] text-[28px]
            ...
            {/* Cities covered */}
            {g.cityNames?.length > 0 && (
              <SideCard title="Cities Covered" icon={<RiMapPin2Line size={13} />}>
                <div className="flex flex-col gap-2.5">
            ...
            <SideCard title="Experience" icon={<TbRoute size={13} />}>
              <div className="flex items-baseline gap-1.5">
                <span className="font-[Playfair_Display,Georgia,serif] text-[26px]
                                 font-bold text-[#3d2b1a]">
                  {g.totalTours}
                </span>
                <span className="text-[13px] text-[#9e8e80] font-[Nunito,sans-serif]">
