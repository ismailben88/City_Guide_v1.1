// components/home/TopSearch.styles.js
...
export const Card = styled.div`
  ...
  ${({ $active }) => $active && css`
    box-shadow: 0 10px 36px rgba(107,156,62,0.22);
...
export const PriceBadge = styled.span`
  ...
  z-index: 2;
  background: ${({ $free }) =>
    $free ? "rgba(107,156,62,0.85)" : "rgba(30,26,20,0.75)"};
  backdrop-filter: blur(8px);
  ...
  border: 1px solid ${({ $free }) =>
    $free ? "rgba(200,217,138,0.35)" : "rgba(244,198,122,0.3)"};
  display: flex;
  align-items: center;
  gap: 4px;
`;
